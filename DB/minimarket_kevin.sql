...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-11-2022 a las 03:10:13
...
CREATE TABLE `productoinv` (
  ...
  `producto_descripcion` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

--
-- Volcado de datos para la tabla `productoinv`
--

INSERT INTO `productoinv` (`producto_id`, `producto_codigo`, `producto_nombre`, `producto_precio`, `producto_stock`, `producto_foto`, `categoria_id`, `usuario_id`, `producto_activo`, `producto_descripcion`) VALUES
(3, '20-01-2026', 'Papaya', '1200.00', 200, '', 5, 1, NULL, ''),
(4, '01-20-2024', 'Aguardiente', '45000.00', 500, '', 4, 1, NULL, '');
...
(16, 'aguardiente', '2022-06-15', 45000, NULL, NULL);
...
ALTER TABLE `productoinv`
  ...
  ADD KEY `productoinv_ibfk_1` (`usuario_id`);
