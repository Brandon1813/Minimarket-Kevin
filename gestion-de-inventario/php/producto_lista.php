<?php
	...
	$campos="productoInv.producto_id,productoInv.producto_codigo,productoInv.producto_nombre,productoInv.producto_precio,productoInv.producto_stock,productoInv.producto_foto,productoInv.categoria_id,productoInv.usuario_id,categoriaInv.categoria_id,categoriaInv.categoria_nombre,usuarioInv.usuario_id,usuarioInv.usuario_nombre,usuarioInv.usuario_apellido";
	...
	if(isset($busqueda) && $busqueda!=""){
		...
		$consulta_datos="SELECT $campos FROM productoInv INNER JOIN categoriaInv ON productoInv.categoria_id=categoriaInv.categoria_id INNER JOIN usuarioInv ON productoInv.usuario_id=usuarioInv.usuario_id WHERE productoInv.categoria_id='$categoria_id' ORDER BY productoInv.producto_nombre ASC LIMIT $inicio,$registros";

		$consulta_total="SELECT COUNT(producto_id) FROM productoInv WHERE categoria_id='$categoria_id'";

	}else{

		$consulta_datos="SELECT $campos FROM productoInv INNER JOIN categoriaInv ON productoInv.categoria_id=categoriaInv.categoria_id INNER JOIN usuarioInv ON productoInv.usuario_id=usuarioInv.usuario_id ORDER BY productoInv.producto_nombre ASC LIMIT $inicio,$registros";

		$consulta_total="SELECT COUNT(producto_id) FROM productoInv";
