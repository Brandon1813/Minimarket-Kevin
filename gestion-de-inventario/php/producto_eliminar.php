<?php
    ...
    $check_producto=$check_producto->query("SELECT * FROM productoInv WHERE producto_id='$product_id_del'");
    ...
    if($check_producto->rowCount()==1){
    	...
    	$eliminar_producto=$eliminar_producto->prepare("DELETE FROM productoInv WHERE producto_id=:id");
