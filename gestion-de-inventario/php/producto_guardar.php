<?php
    ...
    $guardar_producto=$guardar_producto->prepare("INSERT INTO productoInv(producto_codigo,producto_nombre,producto_precio,producto_stock,producto_foto,categoria_id,usuario_id) VALUES(:codigo,:nombre,:precio,:stock,:foto,:categoria,:usuario)");
