<nav class="navbar is-info" role="navigation" aria-label="main navigation">
    ...
    <div class="navbar-brand">
        ...
        <img src="./img/producto/logo.png" width="50" height="100">
        </a>
    ...
    <div id="navbarBasicExample" class="navbar-menu">
        ...
        <div class="navbar-end">
            <div class="navbar-item">
                <div class="buttons">
                    <a href="index.php?vista=user_update&user_id_up=<?php echo $_SESSION['id']; ?>" class="button is-secondary is-rounded">
                        Configuración
                    </a>
                    ...
                    <a href="index.php?vista=info" class="button is-danger is-outlined">
                        ?
                    </a>
